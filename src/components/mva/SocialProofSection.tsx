    ...
    <section className="py-20 px-6 border-t border-border">
      <div className="container mx-auto max-w-[1200px]">
        ...
        <div className="flex justify-center">
          <img alt="Trusted by leading brands" className="h-7 w-auto object-contain opacity-50" loading="lazy" decoding="async" src="/lovable-uploads/9e17c3fc-0fe1-43f4-979f-f144aa260b0d.png" />
        </div>
      </div>
    </section>);
