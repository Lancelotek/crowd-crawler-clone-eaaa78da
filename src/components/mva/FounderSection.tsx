    ...
    <section className="py-20 px-6">
      <div className="container mx-auto max-w-[1200px]">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="rounded-card overflow-hidden bg-secondary max-w-[400px] mx-auto" style={{ maskImage: 'linear-gradient(to bottom, black 75%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 75%, transparent 100%)' }}>
