...
export const translations = {
  ...
  hero: {
    ...
    ctaPrimary: { en: "Calculate how many fans you need ↓", pl: "Oblicz ilu fanów potrzebujesz ↓" },
    ctaSecondary: { en: "Get Your Free Strategy Call →", pl: "Umów bezpłatną konsultację →" },
