...
export const translations = {
  ...
  hero: {
    ...
    hook: { en: "Stop launching to silence. We build you a list of", pl: "Przestań startować w ciszę. Budujemy Ci listę" },
    hookBold: { en: "paying Early Bird subscribers", pl: "płacących subskrybentów Early Bird" },
    hookEnd: { en: "— before your Kickstarter or launch day.", pl: "— zanim ruszy Twój Kickstarter lub premiera." },
    ctaPrimary: { en: "Calculate your MVA", pl: "Oblicz swoje MVA" },
    ctaSecondary: { en: "See how it works", pl: "Zobacz jak to działa" },
