...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Privacy Policy" description="Privacy Policy for JAY23 LLC and the MVA Framework. Learn how we collect, use, and protect your data." canonical="/en/privacy-policy" lang="en" />
