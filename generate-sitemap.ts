...
const enStaticPages: Page[] = [
  ...
  { loc: "/en/report", changefreq: "monthly", priority: "0.5" },
  { loc: "/en/lp", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/thank-you", changefreq: "monthly", priority: "0.3" },
  { loc: "/en/playbook-thank-you", changefreq: "monthly", priority: "0.3" },
  ...
  { loc: "/en/click2pack", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/live", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/kickstarter-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/en/kickstarter-marketing-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/en/crowdfunding-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/en/product-launch-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/en/gamefound", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/tiktok-shop-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/en/founder-influencer", changefreq: "monthly", priority: "0.7" },
  { loc: "/en/launchboom-alternative", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/jellop-alternative", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/agency-2-0-alternative", changefreq: "monthly", priority: "0.8" },
  { loc: "/en/prelaunch-marketing-playbook", changefreq: "monthly", priority: "0.8" },
...
const plStaticPages: Page[] = [
  ...
  { loc: "/pl/lp", changefreq: "monthly", priority: "0.8" },
  { loc: "/pl/thank-you", changefreq: "monthly", priority: "0.3" },
  { loc: "/pl/playbook-thank-you", changefreq: "monthly", priority: "0.3" },
  ...
  { loc: "/pl/click2pack", changefreq: "monthly", priority: "0.8" },
  { loc: "/pl/live", changefreq: "monthly", priority: "0.8" },
  { loc: "/pl/gamefound", changefreq: "monthly", priority: "0.8" },
  { loc: "/pl/tiktok-shop-agency", changefreq: "monthly", priority: "0.9" },
  { loc: "/pl/founder-influencer", changefreq: "monthly", priority: "0.7" },
